...
def generate_pdf_from_steps(steps):
    ...
    placement_text_style = ParagraphStyle(name='PlacementText', alignment=TA_CENTER, leading=34, fontSize=20)
    component_name_style = ParagraphStyle(name='ComponentName', alignment=TA_CENTER, leading=34, fontSize=22)
